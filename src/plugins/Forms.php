...
use library\formapi\SimpleForm;
...
class Forms {
     ...
     * @return SimpleForm
     */
    private function onCreateForm(Player $player): SimpleForm {
        ...
        $form->addButton($valueButton, $textButton, $imageType, $imagePath, "empty");
